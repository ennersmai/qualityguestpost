...
import { ArrowRight, CheckCircle, Rocket, ShieldCheck, Target, Zap, Ticket } from "lucide-react";
              ...
              <div className="relative">
                ...
                <div className="space-y-12">
                  ...
                  <div className="pl-8 relative">
                    ...
                    <p className="text-gray-600 mt-2">It’s a process of contacting blog owners to request permission for your content and links to be published on their site. Our team has been finding blogs where publishing articles is possible. We don’t use private blogging networks; instead, we have built great relationships with thousands of real bloggers and influencers.</p>
                  </div>
                  {/* Step 2 */}
                  <div className="pl-8 relative">
